...
$g=$_POST['username'];
$h=$_POST['password'];
$sql="INSERT INTO `registration`( `name`, `address`, `gender`, `phone_no`,  `email`, `departmentid`, `status`) VALUES ('$a','$b','$c','$d','$e','$f',1)";
...
$h=SHA1($h);
$sql1="INSERT INTO `login`( `userid`, `username`, `password`, `type`, `status`) VALUES ('$u','$g','$h','staff',1)";
...
<body>
  ...
  <div class="container__child signup__form">  
    <form action="" id="myform" method="post" onsubmit="return" >
...
<input  type="radio"  name="gender" text="male" placeholder="j" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
        &nbsp &nbsp <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male		<span class="error" id="gender_error"></span>
      </div>
	  <div class="form-group">

...
$sql = mysqli_query($con,"SELECT * FROM `adddepartment`"); //to fethch data from db
...
$sqls="UPDATE `adddepartment` SET `department_name`='$a',`staffname`='$b' ";

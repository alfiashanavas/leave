...
$sql="INSERT INTO `registration`( `image`,`name`, `address`, `gender`, `phone_no`,  `email`, `departmentid`,`b_salary`, `status`) VALUES ('$m','$a','$b','$c','$d','$e','$f',$sa,1)";
...
$h=SHA1($h);
$sql1="INSERT INTO `login`( `userid`, `username`, `password`, `type`, `status`) VALUES ('$u','$g','$h','u',1)";
$res1=mysqli_query($con,$sql1);


}
/*
$sql1="INSERT INTO `login`(`username`, `password`, `email`, `user_type`, `apstatus`, `status`) VALUES ('$d','$e','$c','c','a',1)";
$result1=mysqli_query($con,$sql1) or die("error");
echo "<script> alert('login');</script>";
$logid="SELECT `logid` FROM `login` WHERE `email`='$c'";
...
echo "<script> alert('logid get');</script>";
$sql="INSERT INTO `customer`(`name`, `phone`, `email_id`, `logid`) VALUES ('$a','$b','$c','$l')";
...
<body>
  ...
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text"leave</h1>
    </div>
	<br>
	</br>
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to leave management system</h1>
  ...
  <div class="container__child signup__form">  
    <form action="" id="myform" method="post" onsubmit="return validate()" enctype="multipart/form-data"> 
	<div class="form-group">
	  ...
	  <div class="form-group">
		...
		<input  type="radio"  name="gender" text="male" placeholder="j" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female">Female
        &nbsp &nbsp <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male">Male	
	<span class="error" id="gender_error"></span>
	 ...
	 <div class="form-group">
	  ...
	  <div class="form-group">
		...
		<span class="error" id="departmentname_error"></span>
      </div>
	  <div class="form-group">
